                                ...
                                if (adminRes.data.index === 0) {
                                    axios
                                        ...
                                        .then((res2) => {
                                            ...
                                            // res2.data.row[33] (email) is empty ->
                                            if (Object.keys(res2.data.row).length <= 33 || res2.data.row[33] === "") {

                                                const body = JSON.stringify({ "row": res2.data.index, "newState": "DIA_PRUEBA" });
                                        ...
                                        .catch((e) => {
                                            // user attempting to login with organization email that's not registered
                                            console.log(e);
                                            router.replace('/admissionOnly');
                                        });
